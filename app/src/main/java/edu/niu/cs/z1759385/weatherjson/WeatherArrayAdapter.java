package edu.niu.cs.z1759385.weatherjson;

/**
 * Created by anilm on 5/5/2016.
 */
...
public class WeatherArrayAdapter extends ArrayAdapter<Weather>
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        viewHolder.lowTV.setText(context.getString(R.string.low_temp,day.lowTemp,day.lowTemp));
